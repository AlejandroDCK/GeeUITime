...
public class RobotPlatformInfoUpdateCallback {
    ...
    public interface SpinePlatformListener {
        ...
        void updateWeatherDes(int weatherState, String weatherStateStr,int currentTemp);
    }
     ...
     *
     * @param weatherState  天气状态码
     * @param weatherStateStr 当前天气
     * @param currentTemp 当前温度
     */
    public void updateWeatherDes(int weatherState, String weatherStateStr,int currentTemp) {
        Log.e("letianpai","========= =======updateViews ============ 5 ===========:");
        if (mSpinePlatformListener != null) {
            Log.e("letianpai","========= =======updateViews ============ 6 ===========:");
            mSpinePlatformListener.updateWeatherDes(weatherState,  weatherStateStr, currentTemp);
        }
    }
