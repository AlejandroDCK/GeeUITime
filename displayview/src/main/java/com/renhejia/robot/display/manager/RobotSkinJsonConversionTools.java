...
public class RobotSkinJsonConversionTools implements ClockViewConsts {
    ...
    public static RobotClockSkin getSpineClockSkin(String json) {
        ...
        try {
            ...
            JSONObject temperatureDes =  getTargetJsonObject(object,TEMPERATURE_DES);
            JSONObject temperatureInfo =  getTargetJsonObject(object,TEMPERATURE_INFO);
...
//                LogUtils.logi("testFileName0","drawAirTemp:======= 111");
            ...
            if (temperatureDes != null) {
                RobotSkinLabel spineSkinLabelTemperature = getSpineSkinLabel(temperatureDes);
                spineClockSkin.setTemperatureDes(spineSkinLabelTemperature);
            }

            //设置 temperatureInfo
            if (temperatureInfo != null) {
                RobotSkinLabel spineSkinLabelTemperature = getSpineSkinLabel(temperatureInfo);
                spineClockSkin.setTemperatureInfo(spineSkinLabelTemperature);
            }
