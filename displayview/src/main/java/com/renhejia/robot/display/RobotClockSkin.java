...
public class RobotClockSkin {
    ...
    private RobotSkinLabel temperatureInfo;
    private RobotSkinLabel temperatureRange;
    private RobotSkinLabel temperatureDes;
    ...
    public void resize(Rect rect) {
        ...
        if (dispRect != rect && origRect != null) {
            ...
            if (temperatureDes != null) {
                temperatureDes.setDispRect(calcDispRect(temperatureDes.getOrigRect(), xRadio, yRadio));

                if (temperatureDes.getOrigTouchRect() != null) {
                    temperatureDes.setDispTouchRect(calcDispRect(temperatureDes.getOrigTouchRect(), xRadio, yRadio));
                }
                else {
                    temperatureDes.setDispTouchRect(calcDispRect(temperatureDes.getOrigRect(), xRadio, yRadio));
                }

                float dispSize = temperatureDes.getOrigSize() * (Math.min(xRadio, yRadio));
                temperatureDes.setDispSize((int) dispSize);
            }
            if (temperatureInfo != null) {
                temperatureInfo.setDispRect(calcDispRect(temperatureInfo.getOrigRect(), xRadio, yRadio));

                if (temperatureInfo.getOrigTouchRect() != null) {
                    temperatureInfo.setDispTouchRect(calcDispRect(temperatureInfo.getOrigTouchRect(), xRadio, yRadio));
                }
                else {
                    temperatureInfo.setDispTouchRect(calcDispRect(temperatureInfo.getOrigRect(), xRadio, yRadio));
                }

                float dispSize = temperatureInfo.getOrigSize() * (Math.min(xRadio, yRadio));
                temperatureInfo.setDispSize((int) dispSize);
            }
    ...
    public RobotSkinLabel getTemperatureInfo() {
        return temperatureInfo;
    }

    public void setTemperatureInfo(RobotSkinLabel temperatureInfo) {
    ...
    public RobotSkinLabel getTemperatureDes() {
        return temperatureDes;
    }
    ...
    public void setTemperatureDes(RobotSkinLabel temperatureDes) {
        this.temperatureDes = temperatureDes;
    }
