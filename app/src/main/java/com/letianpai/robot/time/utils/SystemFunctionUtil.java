...
public class SystemFunctionUtil {
    ...
    public static void wakeUp(Context context) {
        ...
        Log.e("letianpai_sleep_screen","powerManager.isInteractive()2: "+ powerManager.isInteractive());
...
//        ((AlarmManager) context.getSystemService(Context.ALARM_SERVICE)).setTimeZone("Asia/Shanghai");
    ...
    public static void set1224HourFormat(Context context) {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN_MR1) {
            ...
            String timeFormat1 = Settings.System.getString(context.getContentResolver(), Settings.System.TIME_12_24);
        }
    }
