...
public class LauncherConfigManager implements RobotConfigConsts {
    ...
    public void setRobotGeneralInfo(String fansInfo) {
        if (SystemUtil.isInChinese()){
            mRobotSharedPreference.putString(RECENT_GENERAL_INFO, fansInfo);
        }else {
            mRobotSharedPreference.putString(RECENT_GENERAL_INFO_EN, fansInfo);
        }

    }

    public String getRobotGeneralInfo() {
        if (SystemUtil.isInChinese()){
            return mRobotSharedPreference.getString(RECENT_GENERAL_INFO, null);
        }else {
            return mRobotSharedPreference.getString(RECENT_GENERAL_INFO_EN, null);
        }
